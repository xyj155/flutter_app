           ...
           children: <Widget>[
             new Expanded(
               child: new Column(
                 ...
                 children: <Widget>[
                   new Image.asset("assert/imgs/home_icon_1.png",width: 55,height: 55,),
                   new Text("大家一起聊")
                 ],
               ),
             ),
             new Expanded(
                 child: new Column(
                   children: <Widget>[
                     new Image.asset("assert/imgs/home_icon_2.png",width: 55,height: 55,),
                     new Text("约Ta")
                   ],
                 )),
             new Expanded(
                 child: new Column(
                   children: <Widget>[
                     new Image.asset("assert/imgs/home_icon_3.png",width: 55,height: 55,),
                     new Text("下课玩")
                   ],
                 )),
             new Expanded(
                 child: new Column(
                   children: <Widget>[
                     new Image.asset("assert/imgs/home_icon_4.png",width: 55,height: 55,),
                     new Text("在线匹配")
                   ],
                 )),
           ],
